...
De APIs worden ook aangeboden door `data.overheid.nl <https://data.overheid.nl>`_, `Atlas Leefomgeving <http://www.atlasleefomgeving.nl/>`_, `Geoportaal Waterschappen <http://waterschapservices.webgispublisher.nl/Choosemap.aspx>`_, `Ruimtelijkeplannen.nl <http://www.ruimtelijkeplannen.nl/web-roo/roo/?>`_ en internationale open data portalen zoals `data.gov.uk <http://data.gov.uk/>`_ en `http://www.data.gov/ <http://www.data.gov/>`_.

De documentatie wordt beheerd door `Geonovum <http://www.geonovum.nl/>`_ op `GitHub <https://www.github.com/geonovum/PDOK-NGR-documentatie>`_. Bijdrages zijn van harte welkom! 

- Bugs, fouten, voorstellen en suggesties voor verbeteringen en uitbreidingen kunnen via de `issue tracker <https://github.com/Geonovum/PDOK-NGR-documentatie/issues>`_ gemeld worden.
